							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Basics$toString(model.result.stars))
									])),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										A2(_elm_lang$core$Basics_ops['++'], 'https://github.com/', model.result.name))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(model.result.name)
									]))
							]))
					]))
			]));
};
var _rtfeldman$elm_workshop$Main$model = {
	result: {id: 1, name: 'TheSeamau5/elm-checkerboardgrid-tutorial', stars: 66}
};
var _rtfeldman$elm_workshop$Main$main = {
	main: _rtfeldman$elm_workshop$Main$view(_rtfeldman$elm_workshop$Main$model)
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _rtfeldman$elm_workshop$Main$main === 'undefined' ? null : _rtfeldman$elm_workshop$Main$main);
